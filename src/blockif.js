 ...
 */
import Message, {OkRequest} from './message';
...
async function main() {
  chrome.runtime.sendMessage(new Message.OkRequest({url: getLocation()}),
...
chrome.runtime.onMessage.addListener((message /*, sender, sendResponse*/) => {
  console.log('toggleContentScript');
  const a = new Message(message);
  console.log(a);
